    ...
    <div className="">
      <Link to={`/video/${video?.videoId}`}>
        <div className="flex mb-3 ">
          <div className="relative h-24 lg:h-20 xl:h-24 w-40 min-w-[168px] lg:w-32 lg:min-w-[100px] xl:w-20 xl:min-w-[168px] rounded-xl hover:rounded-none duration-200">
            <img
          ...
          <div className="flex flex-col ml-3 overflow-hidden">
            <span className="text-sm lg:text-xs xl:text-[11px] font-bold line-clamp-2 ">
              {video?.title}
            </span>
